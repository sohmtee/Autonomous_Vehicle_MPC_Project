% LTV-MPC with 2-Input [v_x, delta] + UIO + Sparse Error Recovery (with kinematic model updated)
...
% MPC weights
Q_x_kin = 2000;  Q_psi_kin = 1000;  Q_y_kin = 5000;  
R_dv_kin = 100; R_du_kin = 5000;

Q_x_dyn = 2000;  Q_psi_dyn = 1000;  Q_y_dyn = 5000;  
R_dv_dyn = 100; R_du_dyn = 5000;

% Rate constraints (per step)
dv_max = 2.5 * delta_t;       %acceleration
du_max = deg2rad(5);      %steering rate
...
% Figure 2: sensor attacks vs sparse recovery
figure(2);
subplot(3,1,1);
plot(t_plot, atk_sensor_log(:,1), 'r-', 'LineWidth', 2); hold on;
plot(t_plot, est_sensor_log(:,1), 'b--', 'LineWidth', 2);
ax = gca; ax.XAxis.FontSize = 20; ax.YAxis.FontSize = 20; ax.FontSize = 20; ax.LineWidth = 2;
grid on; ylabel('$e_{s1}, \tilde{e}_{s1}$ (m)', 'Interpreter','latex', 'FontName','Times New Roman' ,'FontSize',28); % e_x channel
...
ax = gca; ax.XAxis.FontSize = 20; ax.YAxis.FontSize = 20; ax.FontSize = 20; ax.LineWidth = 2;
grid on; ylabel('$e_{s2}, \tilde{e}_{s2}$ (rad)', 'Interpreter','latex', 'FontName','Times New Roman' ,'FontSize',28);   % e_psi channel
legend('True drop', 'Estimated', 'FontName','Times New Roman' ,'FontSize',20, 'Location','best');
...
ax = gca; ax.XAxis.FontSize = 20; ax.YAxis.FontSize = 20; ax.FontSize = 20; ax.LineWidth = 2;
grid on; ylabel('$e_{s3}, \tilde{e}_{s3}$ (m)', 'Interpreter','latex', 'FontName','Times New Roman' ,'FontSize',28); % e_y channel
xlabel('Time (s)', 'Interpreter','latex', 'FontName','Times New Roman' ,'FontSize',28);
legend('True drop', 'Estimated', 'FontName','Times New Roman' ,'FontSize',20, 'Location','best');


% Figure 3: output recovery
figure(3);
subplot(3,1,1);
plot(t_plot, ys_ex_log, 'b-', 'LineWidth', 2); hold on;
plot(t_plot, ybar_c_ex_log, 'r--', 'LineWidth', 2);
ax = gca; ax.XAxis.FontSize = 20; ax.YAxis.FontSize = 20; ax.FontSize = 20; ax.LineWidth = 2;
...
subplot(3,1,2);
plot(t_plot, ys_epsi_log, 'b-', 'LineWidth', 2); hold on;
plot(t_plot, ybar_c_epsi_log, 'r--', 'LineWidth', 2);
ax = gca; ax.XAxis.FontSize = 20; ax.YAxis.FontSize = 20; ax.FontSize = 20; ax.LineWidth = 2;
...
subplot(3,1,3);
plot(t_plot, ys_ey_log, 'b-', 'LineWidth', 2); hold on;
plot(t_plot, ybar_c_ey_log, 'r--', 'LineWidth', 2);
ax = gca; ax.XAxis.FontSize = 20; ax.YAxis.FontSize = 20; ax.FontSize = 20; ax.LineWidth = 2;
